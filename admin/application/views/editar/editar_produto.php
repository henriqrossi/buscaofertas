							...
							<div id="principal">
								...
								<div class="row col-11">
									<div class="form-group col-3">
										...
										<div class="col-md-12">
											...
											<select id="codigo_loja" name="codigo_loja" class="form-control" required>
												...
												<option value="0" <?=($prod[0]->codigo_loja == '0' ? 'selected' : '')?>>Delta</option>
												<option value="1" <?=($prod[0]->codigo_loja == '1' ? 'selected' : '')?>>Favetta</option>
												<option value="2" <?=($prod[0]->codigo_loja == '2' ? 'selected' : '')?>>Spani</option>
												<option value="3" <?=($prod[0]->codigo_loja == '3' ? 'selected' : '')?>>Tonin</option>
												<option value="4" <?=($prod[0]->codigo_loja == '4' ? 'selected' : '')?>>Pague Menos</option>
											</select>
										</div>
									</div>
									<div class="form-group col-7">
										...
										<div class="col-md-12">
											<input type="text" id="titulo" name="titulo" class="form-control" maxlength="150" value="<?=$prod[0]->titulo?>" required>
										</div>
									</div>
									<div class="form-group col-2">
										...
										<div class="col-md-12">
											<select name="uMedida" class="form-control">
												<option value="UN" <?=($prod[0]->uMedida == 'UN' ? 'selected' : '')?>>UN</option>
												<option value="CT" <?=($prod[0]->uMedida == 'CT' ? 'selected' : '')?>>CT - (cartela)</option>
												<option value="CX" <?=($prod[0]->uMedida == 'CX' ? 'selected' : '')?>>CX - (Caixa)</option>
												<option value="DZ" <?=($prod[0]->uMedida == 'DZ' ? 'selected' : '')?>>DZ - (Dúzia)</option>
												<option value="GS" <?=($prod[0]->uMedida == 'GS' ? 'selected' : '')?>>GS - (Grosa)</option>
												<option value="PÇ" <?=($prod[0]->uMedida == 'PÇ' ? 'selected' : '')?>>PÇ - (PEÇA)</option>
												<option value="PR" <?=($prod[0]->uMedida == 'PR' ? 'selected' : '')?>>PR - (PAR)</option>
												<option value="PT" <?=($prod[0]->uMedida == 'PT' ? 'selected' : '')?>>PT - (PACOTE)</option>
												<option value="RL" <?=($prod[0]->uMedida == 'RL' ? 'selected' : '')?>>RL - (ROLO)</option>
												<option value="M" <?=($prod[0]->uMedida == 'M' ? 'selected' : '')?>>M - (Metro)</option>
												<option value="CM" <?=($prod[0]->uMedida == 'CM' ? 'selected' : '')?>>CM - (Centímetro)</option>
												<option value="KG" <?=($prod[0]->uMedida == 'KG' ? 'selected' : '')?>>KG - (Quilo)</option>
												<option value="G" <?=($prod[0]->uMedida == 'G' ? 'selected' : '')?>>G - (Grama)</option>
												<option value="SC" <?=($prod[0]->uMedida == 'SC' ? 'selected' : '')?>>SC - (Saca)</option>
												<option value="L" <?=($prod[0]->uMedida == 'L' ? 'selected' : '')?>>L - (Litro)</option>
												<option value="M3" <?=($prod[0]->uMedida == 'M3' ? 'selected' : '')?>>M³ - (Metro Cúbico)</option>
												<option value="ML" <?=($prod[0]->uMedida == 'ML' ? 'selected' : '')?>>ML - (Mililitro)</option>
												<option value="M2" <?=($prod[0]->uMedida == 'M2' ? 'selected' : '')?>>M² - (Metro Quadrado)</option>
												<option value="CM2" <?=($prod[0]->uMedida == 'CM2' ? 'selected' : '')?>>CM² - (Centimetro Quadrado)</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="form-group col-11">
									...
									<label class="col">
										<textarea id="summernote" name="descricao" maxlength="500"><?=$prod[0]->descricao?></textarea>
									</label>
								</div>
							</div>
								...
								<div class="form-group col-11">
									<div class="row">
										<div class="col-md-6 col-12">
											...
											<input type="date" class="form-control" name="dataini" id="dataini" value="<?=$prod[0]->dataini?>" required>
										</div>
										<div class="col-md-6 col-12">
											<label for="datafim">Data Final</label>
											<input type="date" class="form-control" name="datafim" id="datafim" value="<?=$prod[0]->datafim?>" required>
										</div>
									</div>
								</div>
							</div>
							<div id="add" style="display: none">
								<div class="row col-12">
									<div class="form-group col-4">
										...
										<div class="col-md-12">
											<input type="text" id="valor" name="valor" class="form-control" maxlength="10" value="<?=$prod[0]->valor?>">
										</div>
									</div>
								</div>
							</div>
